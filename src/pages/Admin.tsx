...
import { Trash2, Pencil, Plus, Lock, Image as ImageIcon, X, ChevronDown } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";

const ADMIN_PASSWORD = "rabab2024";
const SESSION_KEY = "rabab_admin_auth";

const CATEGORIES = ["Cadeaux de naissance", "Décorations du Ramadan", "Gift Box"];
...
const Admin = () => {
  ...
  useEffect(() => {
    if (authenticated) {
      ensureAnonAuth().then(() => fetchProducts());
    }
  }, [authenticated]);
